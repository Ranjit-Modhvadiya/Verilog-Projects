...
HD_PWD='D:/Verilog Projects/Checking_3/Checking_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Unit.tcl
