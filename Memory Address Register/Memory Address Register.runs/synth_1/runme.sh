...
HD_PWD='D:/Verilog Projects/Memory Address Register/Memory Address Register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temp_Reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Temp_Reg.tcl
