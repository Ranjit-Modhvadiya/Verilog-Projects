...
HD_PWD='D:/Verilog Projects/Processor_Logic_Design/Processor_Logic_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Processor_Logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Processor_Logic.tcl
